      ...
      <div className="privacy">
        ...
        <div className="privacy-container">
          <p>
            ...
            provide, test, improve, promote and personalize Saga.GG Services
            fight spam and other forms of abuse
            generate aggregate, non-identifying information about how people use Saga.GG Services
            ...
            IP address
            Browser information
            Reading history (on Saga.GG network only)
            Network interactions (recommends, follows, etc.)
            Posts, responses, or series published by user

            Saga.GG shares minimal personal data with third-party processors in order to provide the Services. These processors offer at least the same level of data protection as that set out in this statement. This includes the following categories of recipients:
